"""
Django settings for capteurs_site project.
...
SECRET_KEY = 'django-insecure-gcveck%_92)wa_-hosip=wk0tx*(*x(hv&(&+(_$-pz!&pk35('
...
ROOT_URLCONF = 'capteurs_site.urls'
...
WSGI_APPLICATION = 'capteurs_site.wsgi.application'
